/**
 * The help and API documentation, as one HTML string.
 *
 * Single source of truth for two places: the in-app help sheet, and the
 * standalone documentation.html page. Lifted verbatim from the original page so
 * the wording stays upstream's, with the API tables wrapped so they scroll on a
...
<div class="help">
    ...
    <p>
        If your program contains an error, you can use the developer tools in your web
        browser to try and debug it. If you want to start over with the code, press the
        <span class="emphasis-color">Reset</span> button. This will revert the code to a
        working but simplistic implementation.<br />
        If you have a favorite text editor, such as
        <a href="http://www.sublimetext.com/">Sublime Text</a>, feel free to edit the
        code there and paste it into the game editor.<br />
        Your code is automatically saved in your local storage, so don't worry - it
        doesn't disappear if you accidentally close the browser.
    </p>
    <h2>Basics</h2>
    <p>
        Your code must declare an object containing at least two functions called
        <span class="emphasis-color">init</span> and
    ...
    <p>
        ...
        starts, and <span class="emphasis-color">update</span> repeatedly during the
        challenge.
    </p>
    <p>
        Normally you will put most of your code in the
        <span class="emphasis-color">init</span> function, to set up event listeners and
        logic.
    </p>
    <h2>Code examples</h2>
    ...
    <dl>
        ...
        <dd>
            ...
            Note that this will have no effect if the elevator is already queued to go
            to that floor.
        </dd>
        <dt>
        ...
        <dd>
            ...
            on. Note that this is a rounded number and does not necessarily mean the
            elevator is in a stopped state.
        </dd>
    </dl>
    <h3>Listening for events</h3>
    <p>
        It is possible to listen for events, like when stopping at a floor, or a button
        has been pressed.
    </p>
    <dl>
        <dt>
        ...
        <dd>
            ...
            been emptied and the elevator is doing nothing. In this example we tell it
            to move to floor 0.
        </dd>
        <dt>
        ...
        <dd>
            ...
            a button inside the elevator. This indicates that the passenger wants to go
            to that floor.
        </dd>
        <dt>
        ...
        <dd>
            ...
            the up button on the floor they are waiting on. This indicates that the
            passenger wants to go to another floor.
        </dd>
    </dl>
    ...
    <div class="doctablewrap"><table class="doctable">
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <small
                        >Queue the elevator to go to specified floor number. If you
                        specify true as second argument, the elevator will go to that
                        floor directly, and then go to any other queued floors.</small
                    >
                </td>
                <td>
...
elevator.goToFloor(2, true); // Do it before anything else</code></pre>
            ...
            <tr>
                ...
                <td>
                    <small
                        >Clear the destination queue and stop the elevator if it is
                        moving. Note that you normally don't need to stop elevators - it
                        is intended for advanced solutions with in-transit rescheduling
                        logic. Also, note that the elevator will probably not stop at a
                        floor, so passengers will not get out.</small
                    >
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <small
                        >Gets the floor number that the elevator currently is on.</small
                    >
                </td>
                <td>
    ...
    // Do something special?
            ...
            <tr>
                ...
                <td>
                    <small
                        >Gets or sets the going up indicator, which will affect
                        passenger behaviour when stopping at floors.</small
                    >
                </td>
                <td>
    ...
    elevator.goingDownIndicator(false);
            ...
            <tr>
                ...
                <td>
                    <small
                        >Gets or sets the going down indicator, which will affect
                        passenger behaviour when stopping at floors.</small
                    >
                </td>
                <td>
    ...
    elevator.goingUpIndicator(false);
            ...
            <tr>
                ...
                <td>
                    <small
                        >Gets the maximum number of passengers that can occupy the
                        elevator at the same time.</small
                    >
                </td>
                <td>
    ...
    // Use this elevator for something special, because it's big
            ...
            <tr>
                ...
                <td>
                    <small
                        >Gets the load factor of the elevator. 0 means empty, 1 means
                        full. Varies with passenger weights, which vary - not an exact
                        measure.</small
                    >
                </td>
                <td>
    ...
    // Maybe use this elevator, since it's not full yet?
            ...
            <tr>
                ...
                <td>
                    <small
                        >Gets the direction the elevator is currently going to move
                        toward. Can be "up", "down" or "stopped".</small
                    >
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <small
                        >The current destination queue, meaning the floor numbers the
                        elevator is scheduled to go to. Can be modified and emptied if
                        desired. Note that you need to call checkDestinationQueue() for
                        the change to take effect immediately.</small
                    >
                </td>
                <td>
...
elevator.checkDestinationQueue();</code></pre>
            ...
            <tr>
                ...
                <td>
                    <small
                        ...
                        Note that you only need to call this if you modify the
                        destination queue explicitly.</small
                    >
                </td>
                <td>
    ...
    <div class="doctablewrap"><table class="doctable">
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <small
                        >Triggered when the elevator has completed all its tasks and is
            ...
            <tr>
                ...
                <td>
                    <small
                        >Triggered when a passenger has pressed a button inside the
                        elevator.</small
                    >
                </td>
                <td>
    ...
    // Maybe tell the elevator to go to that floor?
            ...
            <tr>
                ...
                <td>
                    <small
                        >Triggered slightly before the elevator will pass a floor. A
                        good time to decide whether to stop at that floor. Note that
                        this event is not triggered for the destination floor. Direction
                        is either "up" or "down".</small
                    >
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <small
                        ...
                        Note that passengers will press the button again if they fail to
                        enter an elevator.</small
                    >
                </td>
                <td>
